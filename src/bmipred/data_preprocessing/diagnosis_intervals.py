...
def diagnosis_intervals(df: pd.DataFrame, 
    ...
    # This function preprocesses the diagnosis table in order to concatenate overlapping time intervals for the same patient and diagnosis.
    # codesMap_groups_col: "SKSCodes_range" can be changed to SKSCodes if we want to keep the original SKS codes instead of the broader categories.
